var d3multilineplot2 = function(ahref, path, filename, extension) {
d3.dsv("	", "text/plain")(path+filename+extension, function(error, csv) {
    ...
    var label_width = 120, label_right = 2, label_top = 4;
